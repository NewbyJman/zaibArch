...
xfconf-query -c xfce4-keyboard-shortcuts -p /commands/custom/"<Super>b" -n -t string -s "waterfox --private-window https://google.co.uk"
xfconf-query -c xfce4-keyboard-shortcuts -p /commands/custom/"<Super>y" -n -t string -s "waterfox --private-window https://www.youtube.com/?persist_gl=1&gl=US"
